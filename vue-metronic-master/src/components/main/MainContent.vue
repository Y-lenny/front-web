<!-- 模板 -->
<template>
  <div id="body" class="page-header-fixed page-sidebar-closed-hide-logo">
    <!-- BEGIN HEADER -->
          ...
          <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
            ...
            <li class="nav-item  ">
              ...
              <ul class="sub-menu">
                <li class="nav-item  ">
                  <a href="javascript:;" class="nav-link nav-toggle">
                    <span class="title">../../assets Tables</span>
                    <span class="arrow"></span>
                  </a>
                  <ul class="sub-menu">
                    <li class="nav-item ">
                      <a href="table_../../assets_basic.html" class="nav-link "> Basic Tables </a>
                    </li>
                    <li class="nav-item ">
                      <a href="table_../../assets_responsive.html" class="nav-link "> Responsive Tables </a>
                    </li>
                    <li class="nav-item ">
          ...
          <div class="theme-panel hidden-xs hidden-sm">
            ...
            <div class="theme-options">
              <div class="theme-option theme-colors clearfix">
                ...
                <ul>
                  <li class="color-default current tooltips" data-style="defaultTheme" data-container="body" data-original-title="Default"> </li>
                  <li class="color-darkblue tooltips" data-style="darkblueTheme" data-container="body" data-original-title="Dark Blue"> </li>
                  <li class="color-blue tooltips" data-style="blueTheme" data-container="body" data-original-title="Blue"> </li>
                  <li class="color-grey tooltips" data-style="greyTheme" data-container="body" data-original-title="Grey"> </li>
                  <li class="color-light tooltips" data-style="lightTheme" data-container="body" data-original-title="Light"> </li>
                  <li class="color-light2 tooltips" data-style="light2Theme" data-container="body" data-html="true" data-original-title="Light 2"> </li>
                </ul>
              </div>
              ...
              <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                ...
                <ul class="media-list list-items">
                  <li class="media">
                    ...
                    <img class="media-object" src="../../assets/metronic/layouts/layout/img/avatar3.jpg" alt="...">
                  ...
                  <li class="media">
                    <img class="media-object" src="../../assets/metronic/layouts/layout/img/avatar1.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    ...
                    <img class="media-object" src="../../assets/metronic/layouts/layout/img/avatar4.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    <img class="media-object" src="../../assets/metronic/layouts/layout/img/avatar2.jpg" alt="...">
                    <div class="media-body">
                ...
                <ul class="media-list list-items">
                  <li class="media">
                    ...
                    <img class="media-object" src="../../assets/metronic/layouts/layout/img/avatar6.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    ...
                    <img class="media-object" src="../../assets/metronic/layouts/layout/img/avatar7.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    <img class="media-object" src="../../assets/metronic/layouts/layout/img/avatar8.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    ...
                    <img class="media-object" src="../../assets/metronic/layouts/layout/img/avatar9.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    <img class="media-object" src="../../assets/metronic/layouts/layout/img/avatar10.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    ...
                    <img class="media-object" src="../../assets/metronic/layouts/layout/img/avatar11.jpg" alt="...">
                    <div class="media-body">
              ...
              <div class="page-quick-sidebar-item">
                <div class="page-quick-sidebar-chat-user">
                  ...
                  <div class="page-quick-sidebar-chat-user-messages">
                    <div class="post out">
                      <img class="avatar" alt="" src="../../assets/metronic/layouts/layout/img/avatar3.jpg" />
                      <div class="message">
                        <span class="arrow"></span>
                    ...
                    <div class="post in">
                      <img class="avatar" alt="" src="../../assets/metronic/layouts/layout/img/avatar2.jpg" />
                      <div class="message">
                        <span class="arrow"></span>
...
<script>
  ...
  const Demo = require("!exports?Demo!../../assets/metronic/layouts/layout/scripts/demo.min")
  const QuickSidebar = require("!exports?QuickSidebar!../../assets/metronic/layouts/global/scripts/quick-sidebar.min")

  import auth from '../../assets/js/api/auth'
  import { logout, currentUser } from '../../assets/js/vuex/actions'
  import { user } from '../../assets/js/vuex/getters'
  ...
  export default {
    ...
    attached: function () {
      $(".pace .pace-progress").css("top", "46px");
      //获取用户信息
      this.currentUser()
    },
    detached: function () {
      $(".pace .pace-progress").css("top", "0px");
    }
  }
</script>
