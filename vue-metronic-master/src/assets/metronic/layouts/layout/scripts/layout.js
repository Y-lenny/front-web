...
var Layout = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        $('.page-sidebar-menu').on('click', 'li > a.nav-toggle, li > a > span.nav-toggle', function (e) {
            ...
            if (App.getViewPort().width >= resBreakpointMd && !$('.page-sidebar-menu').attr("data-initialized") && $('div#body').hasClass('page-sidebar-closed') &&  that.parent('li').parent('.page-sidebar-menu').size() === 1) {
                return;
            }
            ...
            if (sub.is(":visible")) {
                ...
                sub.slideUp(slideSpeed, function () {
                    if (autoScroll === true && $('div#body').hasClass('page-sidebar-closed') === false) {
        ...
        $('.sidebar-search .submit').on('click', function (e) {
            e.preventDefault();
            if ($('div#body').hasClass("page-sidebar-closed")) {
    ...
    var handleSidebarToggler = function () {
        ...
        if ($.cookie && $.cookie('sidebar_closed') === '1' && App.getViewPort().width >= resBreakpointMd) {
            $('div#body').addClass('page-sidebar-closed');
            $('.page-sidebar-menu').addClass('page-sidebar-menu-closed');
        }

        // handle sidebar show/hide
        $('div#body').on('click', '.sidebar-toggler', function (e) {
            var sidebar = $('.page-sidebar');
    ...
    var handleTabs = function () {
        ...
        $('div#body').on('shown.bs.tab', 'a[data-toggle="tab"]', function () {
            handleSidebarAndContentHeight();
        });
    };
    ...
    var handleGoTop = function () {
        ...
        $('.scroll-to-top').click(function(e) {
            e.preventDefault();
            $('html, body, div').animate({scrollTop: 0}, duration);
            return false;
        });
    };
