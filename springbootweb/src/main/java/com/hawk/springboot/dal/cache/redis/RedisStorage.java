package com.hawk.springboot.dal.cache.redis;


import com.hawk.springboot.common.FstSerializer;
import com.hawk.springboot.common.Serializer;
...
public class RedisStorage {
	...
	private Serializer transcoder = new FstSerializer(); // 序列化编码器
	 ...
	 *            - 序列化编码器
	 */
	public void setTranscoder(Serializer transcoder) {
